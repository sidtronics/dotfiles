...
beautiful.wallpaper = awful.util.get_configuration_dir() .. "watchtower.jpg"
...
mytextclock = wibox.widget.textclock (" | %a %b | %d-%m-%y | %X", 1)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Other widgets
    local bat_widget = require('widgets.battery-widget.battery')
    local net_wireless = net_widgets.wireless({interface="wlp0s20f3", popup_signal=true})
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            net_wireless,
            bat_widget({display_notification = true}),
            mytextclock,
            s.mylayoutbox,
        },
    }
...
globalkeys = gears.table.join(
    ...
    --[[awful.key({ "Mod1"}, "Tab", function () awful.client.focus.byidx(1) end,
              {description = "focus to next client", group = "client"}),
